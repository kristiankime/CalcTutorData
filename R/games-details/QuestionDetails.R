QuestionDetails <- function() {
  ...
  derivative.question.group <- ftable(db.derivative.questions.dt)$select(quiz_id=quiz_id, asker_id=owner, question_id=id, question_difficulty=at_creation_difficulty, type="der")$dt 
  ...
  tangent.question.group <- ftable(db.tangent.questions.dt)$select(quiz_id=quiz_id, asker_id=owner, question_id=id, question_difficulty=at_creation_difficulty, type="der")$dt 
