QuestionDetails <- function() {
  ...
  tangent.question.group <- ftable(db.tangent.questions.dt)$select(quiz_id=quiz_id, asker_id=owner, question_id=id, question_difficulty=at_creation_difficulty, type="tan", question=paste0(function_str, " @ ", at_point_x_str))$dt 
